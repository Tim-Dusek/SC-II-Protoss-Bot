...
class TimTossBotV2(sc2.BotAI):
    ...
    async def on_step(self, iteration):
        self.timeVar = (self.state.game_loop/22.4) / 60
        #print (self.timeVar)
...
########
    ...
    async def build_scout(self):
        for rf in self.units(ROBOTICSFACILITY).ready.noqueue:
            print(len(self.units(OBSERVER)), self.timeVar/3)
    ...
    async def do_nothing(self):
        ...
        self.do_something_after = self.timeVar + wait
        print("Current Time:", self.timeVar)
        print("Waiting until:", self.timeVar+wait)
    ...
    async def do_something(self):
        ...
        if self.timeVar > self.do_something_after:
            if self.use_model:
            ...
            try:
                print("Random Choice was:", choice)
...
if True:
    run_game(maps.get("AbyssalReefLE"), [
        Bot(Race.Protoss, TimTossBotV2(use_model=False, title=1)),
        #Bot(Race.Protoss, TimTossBotV2(use_model=False, title=2)),
