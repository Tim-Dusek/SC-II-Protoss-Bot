#In cmd from Desktop: tensorboard --logdir "SCII Bots"
import keras  # Keras 2.1.2 and TF-GPU 1.8.0 and CUDA v 9.0.xxx and cudnn64_7.dll from cudnn 9.0
...
#folder we find all training data in.
...
# if you want to load in a previously trained model that you want to further train:
# keras.models.load_model(filepath)

#number of times we go through our data files (2869 files at this point of comment)
hm_epochs = 10
...
for i in range(hm_epochs):
    ...
    while not_maximum:
        ...
        #not out of sample because of shuffle
